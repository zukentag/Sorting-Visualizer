...
class Visualizer extends React.Component {
  ...
  // for initial generation of the list
  //componentDidMount() is invoked immediately after a component is mounted (inserted into the tree)
  componentDidMount() {
    this.generateList();
  }

  // for updating any change in state/event
  ...
  // for updating the state on changing navbar options  avoid changing algorithm and size when algorithm is running
